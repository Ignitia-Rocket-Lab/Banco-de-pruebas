...
#define ANGLE_OPEN 66         // Ángulo para "ON" (ajustable)
#define ANGLE_CLOSED 31        // Ángulo para "OFF" (ajustable)
...
void openSwitch();            // Mueve a posición ON
void closeSwitch();           // Mueve a posición OFF
